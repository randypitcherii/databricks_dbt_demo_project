...
SELECT 
    ...
    LINE_ITEM.EXTENDED_PRICE + (-1 * LINE_ITEM.EXTENDED_PRICE * LINE_ITEM.DISCOUNT_PERCENTAGE) + ((LINE_ITEM.EXTENDED_PRICE + (-1 * LINE_ITEM.EXTENDED_PRICE * LINE_ITEM.DISCOUNT_PERCENTAGE)) * LINE_ITEM.TAX_RATE) AS NET_ITEM_SALES_AMOUNT
